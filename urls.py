...
urlpatterns = [
    ...
    path('employeeHoursAdd', views.employeeHoursAdd_view, name='employeeHoursAdd'),
        # Get employee hours information; comes after employeeHoursQuery
    path('employeeHoursEdit', views.employeeHoursEdit_view, name='employeeHoursEdit'),
    # Search employees to update hours
    path('employeeHoursEditSelect', views.employeeHoursEditSelect_view, name='employeeHoursEditSelect'),

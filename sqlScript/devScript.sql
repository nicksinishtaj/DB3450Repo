...
CREATE TABLE `supplier_contact` (
  ...
  `SUPPLIER_CONTACT_SUPPLIER_ID` int NOT NULL,
  ...
  UNIQUE KEY `SUPPLIER_CONTACT_ID_UNIQUE` (`SUPPLIER_CONTACT_ID`),
  KEY `SUPPLIER_CONTACT_SUPPLIER_ID` (`SUPPLIER_CONTACT_SUPPLIER_ID`),
...
-- Insert Sample Employee Hours
INSERT INTO EMPLOYEE_HOURS SET
EMPLOYEE_ID = 1,
PROJECT_ID = 1,
EMPLOYEE_HOURS_FIRST_DAY = "2020-04-13",
EMPLOYEE_HOURS_RATE = 10,
EMPLOYEE_HOURS_SUN1 = 1,
EMPLOYEE_HOURS_MON1 = 2,
EMPLOYEE_HOURS_TUE1 = 3,
EMPLOYEE_HOURS_WED1 = 4,
EMPLOYEE_HOURS_THR1 = 5,
EMPLOYEE_HOURS_FRI1 = 6,
EMPLOYEE_HOURS_SAT1 = 7,
EMPLOYEE_HOURS_SUN2 = 8,
EMPLOYEE_HOURS_MON2 = 9,
EMPLOYEE_HOURS_TUE2 = 10,
EMPLOYEE_HOURS_WED2 = 11,
EMPLOYEE_HOURS_THR2 = 12,
EMPLOYEE_HOURS_FRI2 = 13,
EMPLOYEE_HOURS_SAT2 = 14;
...
EMPLOYEE_HOURS_FIRST_DAY = "2020-04-13",
EMPLOYEE_HOURS_RATE = 10,
EMPLOYEE_HOURS_SUN1 = 10,
EMPLOYEE_HOURS_MON1 = 20,
EMPLOYEE_HOURS_TUE1 = 30,
EMPLOYEE_HOURS_WED1 = 40,
EMPLOYEE_HOURS_THR1 = 50,
EMPLOYEE_HOURS_FRI1 = 60,
EMPLOYEE_HOURS_SAT1 = 70,
EMPLOYEE_HOURS_SUN2 = 80,
EMPLOYEE_HOURS_MON2 = 90,
EMPLOYEE_HOURS_TUE2 = 100,
EMPLOYEE_HOURS_WED2 = 110,
EMPLOYEE_HOURS_THR2 = 120,
EMPLOYEE_HOURS_FRI2 = 130,
EMPLOYEE_HOURS_SAT2 = 140;

INSERT INTO EMPLOYEE_HOURS SET
EMPLOYEE_ID = 1,
EMPLOYEE_HOURS_FIRST_DAY = "2020-04-13",
EMPLOYEE_HOURS_RATE = 10,
EMPLOYEE_HOURS_SUN1 = 0,
EMPLOYEE_HOURS_MON1 = 8,
EMPLOYEE_HOURS_TUE1 = 8,
EMPLOYEE_HOURS_WED1 = 8,
EMPLOYEE_HOURS_THR1 = 8,
EMPLOYEE_HOURS_FRI1 = 8,
EMPLOYEE_HOURS_SAT1 = 0,
EMPLOYEE_HOURS_SUN2 = 0,
EMPLOYEE_HOURS_MON2 = 10,
EMPLOYEE_HOURS_TUE2 = 10,
EMPLOYEE_HOURS_WED2 = 10,
EMPLOYEE_HOURS_THR2 = 10,
EMPLOYEE_HOURS_FRI2 = 0,
...
PROJECT_ID = 1,
EMPLOYEE_HOURS_FIRST_DAY = "2020-04-13",
EMPLOYEE_HOURS_RATE = 15,
EMPLOYEE_HOURS_SUN1 = 0,
EMPLOYEE_HOURS_MON1 = 0,
EMPLOYEE_HOURS_TUE1 = 4,
EMPLOYEE_HOURS_WED1 = 0,
EMPLOYEE_HOURS_THR1 = 8,
EMPLOYEE_HOURS_FRI1 = 0,
EMPLOYEE_HOURS_SAT1 = 0,
EMPLOYEE_HOURS_SUN2 = 0,
EMPLOYEE_HOURS_MON2 = 0,
EMPLOYEE_HOURS_TUE2 = 4,
EMPLOYEE_HOURS_WED2 = 0,
EMPLOYEE_HOURS_THR2 = 8,
EMPLOYEE_HOURS_FRI2 = 0,
EMPLOYEE_HOURS_SAT2 = 0;
...
EMPLOYEE_HOURS_TUE1 = 4,
EMPLOYEE_HOURS_WED1 = 8,
EMPLOYEE_HOURS_THR1 = 0,
EMPLOYEE_HOURS_FRI1 = 0,
EMPLOYEE_HOURS_SAT1 = 0,
EMPLOYEE_HOURS_SUN2 = 0,
EMPLOYEE_HOURS_MON2 = 0,
EMPLOYEE_HOURS_TUE2 = 4,
EMPLOYEE_HOURS_WED2 = 8,
EMPLOYEE_HOURS_THR2 = 0,
EMPLOYEE_HOURS_FRI2 = 0,
EMPLOYEE_HOURS_SAT2 = 0;
...
EMPLOYEE_HOURS_SUN1 = 0,
EMPLOYEE_HOURS_MON1 = 8,
EMPLOYEE_HOURS_TUE1 = 0,
EMPLOYEE_HOURS_WED1 = 0,
EMPLOYEE_HOURS_THR1 = 0,
EMPLOYEE_HOURS_FRI1 = 8,
EMPLOYEE_HOURS_SAT1 = 0,
EMPLOYEE_HOURS_SUN2 = 0,
EMPLOYEE_HOURS_MON2 = 8,
EMPLOYEE_HOURS_TUE2 = 0,
EMPLOYEE_HOURS_WED2 = 0,
EMPLOYEE_HOURS_THR2 = 0,
